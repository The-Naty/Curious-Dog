...
const Toggler = ({ checkedState, updateStateHandler, togglerText }: Props) => {
  return (
    <label className="relative inline-flex items-center cursor-pointer mb-2">
      ...
      <span className="ml-3 text-sm font-medium text-gray-900 dark:text-gray-300">{togglerText}</span>
    </label>
  );
};
